...
export default {
    ...
    methods: {
        ...mapActions(useRegisterStore, ['fetchProfile', 'logout'])
    }
...
<template>
    <sidebar class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
                aria-hidden="true" id="iconSidenav"></i>

            <RouterLink class="navbar-brand d-flex align-items-center m-0" to="/">
                <span class="font-weight-bold text-lg">PasarKoin</span>
            </RouterLink>
        </div>
        <div class="px-4" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                                ...
                                <div class="col-8 my-auto">
                                    <div class="d-flex">
                                        <div class="p-1" style="overflow: hidden;">
                                            <p class="text-sm mb-1">Balance</p>
                                            <p class="mb-0 font-weight-bold overflow-auto m-auto">{{
                                                profile.balance?.toLocaleString("id-ID", {
                                                    style:
                ...
                <li class="nav-item">
                    <RouterLink class="nav-link" to="/trades">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <RouterLink class="nav-link" to="/deposits">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item border-start my-0 pt-2">
                    ...
                    <a class="nav-link position-relative ms-0 ps-2 py-2 " href="#" @click.prevent="logout">
